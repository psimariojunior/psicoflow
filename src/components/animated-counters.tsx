...
function Counter({ end, suffix = "", label, icon }: AnimatedCounterProps) {
  ...
  return (
    ...
    >
      {icon && <div className="text-teal-500 mb-2 flex justify-center">{icon}</div>}
      <div className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-teal-500 to-teal-500 bg-clip-text text-transparent tabular-nums">
        {count}{suffix}
      </div>
