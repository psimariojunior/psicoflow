      ...
      <div className="max-w-2xl mx-auto px-4 pb-8">
        <div className="grid grid-cols-3 gap-3 mb-8">
          {[
            ...
            <div key={label} className="bg-card rounded-2xl p-4 text-center ring-1 ring-border">
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-muted-foreground">Consultas online com duração de 30 minutos</p>
        </div>
      </div>
    </div>
  )
