...
const MOODS = [
  ...
  { value: 4, icon: Smile, label: "Bom", color: "text-primary", bg: "bg-teal-500/10", ring: "ring-primary/30" },
    ...
    <div className="max-w-2xl mx-auto px-4 py-8">
      ...
      <div className="bg-card rounded-2xl p-6 ring-1 ring-border mb-8">
        ...
        <Button onClick={handleSave} disabled={saving || mood === 0}
          className="w-full h-12 font-semibold bg-gradient-to-r from-teal-500 to-teal-600 rounded-xl shadow-xl shadow-teal-500/25"
        >
