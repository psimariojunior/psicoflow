export async function GET() {
  ...
  <rect x="320" y="370" width="140" height="32" rx="16" fill="#0D9488" opacity="0.15"/>
  ...
  <rect x="475" y="370" width="160" height="32" rx="16" fill="#0D9488" opacity="0.15"/>
  ...
  <rect x="650" y="370" width="170" height="32" rx="16" fill="#0D9488" opacity="0.15"/>
  ...
  <rect x="835" y="370" width="130" height="32" rx="16" fill="#0D9488" opacity="0.15"/>
