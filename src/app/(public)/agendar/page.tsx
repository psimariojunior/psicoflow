...
function AgendarPage() {
  ...
  if (loading) {
    return (
      <div className="flex min-h-screen bg-gradient-to-br from-slate-50 via-teal-50 to-slate-100 dark:from-slate-900 dark:via-teal-950 dark:to-slate-900 items-center justify-center transition-colors">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-teal-50 to-slate-100 dark:from-slate-900 dark:via-teal-950 dark:to-slate-900 transition-colors">
      <div className="max-w-5xl mx-auto px-4 py-12">
        <div className="text-center mb-10">
          ...
          <div className="inline-flex items-center justify-center h-16 w-16 rounded-2xl bg-gradient-to-br from-teal-500 to-indigo-600 shadow-xl shadow-teal-500/20 mb-4">
              ...
              >
                ...
                <div className="relative flex items-start gap-4">
                  {psy.avatarUrl ? (
                    ...
                    <div className="rounded-2xl bg-gradient-to-br from-teal-500/20 to-indigo-500/20 dark:from-teal-500/30 dark:to-indigo-500/30 flex items-center justify-center ring-2 ring-slate-200 dark:ring-white/10 shrink-0" style={{ width: 72, height: 72 }}>
                      <User className="h-8 w-8 text-teal-500 dark:text-teal-400" />
                    </div>
                  )}
                  <div className="min-w-0 flex-1">
                    <h2 className="text-lg font-bold text-slate-900 dark:text-white group-hover:text-teal-600 dark:group-hover:text-teal-300 transition-colors">
                      {psy.publicName || psy.name}
                    </h2>
                    {psy.specialty && (
                      <p className="text-teal-600 dark:text-teal-400 text-sm mt-0.5">{psy.specialty}</p>
                    )}
                  ...
                  <ArrowRight className="h-5 w-5 text-slate-300 dark:text-white/20 group-hover:text-teal-500 dark:group-hover:text-teal-400 group-hover:translate-x-1 transition-all shrink-0 mt-1" />
                </div>
                {psy.welcomeMessage && (
                  <p className="relative mt-4 pt-4 border-t border-slate-100 dark:border-white/5 text-slate-400 dark:text-teal-200/40 text-xs italic line-clamp-2">
        ...
        <div className="mt-12 flex flex-col items-center gap-6">
          ...
          <div className="flex items-center justify-center gap-3">
            <div className="flex items-center justify-center w-8 h-8 rounded-lg overflow-hidden bg-gradient-to-br from-teal-500 to-teal-600 ring-1 ring-teal-500/30">
